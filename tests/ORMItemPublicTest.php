...
use Tests\ItemPublic;

final class ORMItemPublicTest extends TestCase
{
	...
	private function testORMRead(ORM $orm, ItemPublic $obj, string $name): void
	{
		$object = $orm->find(ItemPublic::class, (int) $obj->id);
	...
	private function testORMUpdate(ORM $orm, ItemPublic $obj): void
	{
	...
	private function testORMRemove(ORM $orm, ItemPublic $obj): void
	{
	...
	public function testORMReadNotFound(): void
	{
		...
		$result = $model->find(ItemPublic::class, -1);
	...
	public function testORMRepository(): void
	{
		...
		$repo = $orm->getRepository(ItemPublic::class);
		$result = $repo->add($obj);
	...
	/** @param Repository<ItemPublic> $repo */
